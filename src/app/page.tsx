...
export default function BackgroundBoxesDemo() {
  ...
  const mainContentTransform =
    scrollY > 100 ? "translateY(-50px)" : "translateY(0)";
    ...
    <div className="relative bg-slate-900">
      ...
      <LoadingScreen
        ...
        loadingMessages={[
          ...
          "Connecting with verified experts...",
          "Preparing your assignment platform...",
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-4 px-4 max-w-3xl mx-auto text-center">
          ...
          <div className="mt-2 text-gray-400 text-xs sm:text-lg max-w-xl">
            ...
            100% AI-free, plagiarism-free content.
          </div>
        </div>
      ...
      <footer className="w-full flex flex-col items-center justify-center py-6 text-center text-xs text-gray-400">
        <div className="mt-1">
          Copyright &copy; {new Date().getFullYear()} asshelp All rights
          reserved.
        </div>
      </footer>
    </div>
